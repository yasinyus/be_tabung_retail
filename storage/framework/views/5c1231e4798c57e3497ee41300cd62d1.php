<!-- Stats Cards -->
<div class="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-7 mb-6">
    <!-- Total Tabung -->
        ...
        <table style="width: 100%" class="min-w-full">
            <thead class="bg-gray-100 dark:bg-gray-700">
                <tr>
                    ...
                    <td scope="col"  style="width: 15%" class="px-4 py-3 text-center text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tdacking-wider">
                        Kode
                    </td>
                    <td scope="col"  style="width: 15%" class="px-4 py-3 text-center text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tdacking-wider">
                        Jumlah Tabung
...
<div class="bg-gray-50 dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 mt-6">
    ...
    <div class="overflow-x-auto">
        <table style="width: 100%" class="min-w-full">
            <thead class="bg-gray-100 dark:bg-gray-700">
                <tr>
                    <td scope="col" style="width: 15%" class="px-4 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">
                        Pelanggan
                    </td>
                    <td scope="col" style="width: 15%" class="px-4 py-3 text-center text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">
                        Kode
                    </td>
                    <td scope="col" style="width: 15%" class="px-4 py-3 text-center text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">
                        Total
