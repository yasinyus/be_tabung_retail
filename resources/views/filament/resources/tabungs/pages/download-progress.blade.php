<x-filament-panels::page>
    <div class="space-y-6">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
            <div class="flex items-center justify-between mb-4">
                ...
                <div>
                    <a href="{{ route('filament.admin.resources.tabungs.index') }}" 
            ...
            <div class="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-bold text-blue-900 dark:text-blue-100">{{ $totalDownloads }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-yellow-50 dark:bg-yellow-900/20 rounded-lg p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-bold text-yellow-900 dark:text-yellow-100">{{ $pendingDownloads }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-orange-50 dark:bg-orange-900/20 rounded-lg p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-bold text-orange-900 dark:text-orange-100">{{ $processingDownloads }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-green-50 dark:bg-green-900/20 rounded-lg p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-bold text-green-900 dark:text-green-100">{{ $completedDownloads }}</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        @if($pendingDownloads > 0 || $processingDownloads > 0)
        setTimeout(function() {
