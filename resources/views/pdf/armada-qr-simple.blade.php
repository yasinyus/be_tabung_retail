...
<body>
    <div class="header">
        <h2>QR Codes Armada</h2>
        <p>Generated: {{ date('d/m/Y H:i') }} | Total: {{ count($qrData) }} vehicles</p>
    </div>
            ...
            <tr>
                @foreach($chunk as $data)
                    <td class="qr-cell">
                        ...
                        <div class="info">
                            <div class="nopol">Nopol: {{ $data['armada']->nopol }}</div>
                            <div>Kapasitas: {{ $data['armada']->kapasitas }} ton</div>
                            <div>Tahun: {{ $data['armada']->tahun_armada }}</div>
                            <div>Jenis: {{ $data['armada']->jenis_armada }}</div>
                        </div>
                    </td>
                @endforeach
