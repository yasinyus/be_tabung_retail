# 🧪 PowerShell API Testing Script untuk test.gasalamsolusi.my.id

Write-Host "🚀 Starting Live API Tests for test.gasalamsolusi.my.id" -ForegroundColor Green
...
Write-Host "- Homepage: https://test.gasalamsolusi.my.id"
Write-Host "- Admin: https://test.gasalamsolusi.my.id/admin"
Write-Host "- API Test: https://test.gasalamsolusi.my.id/api/test"

Write-Host "`n📱 For Flutter integration:" -ForegroundColor Yellow
Write-Host "- Base URL: https://test.gasalamsolusi.my.id/api"
Write-Host "- Auth endpoint: /login-staff and /login-pelanggan"
